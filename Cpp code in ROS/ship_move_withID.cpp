...
const int q=147;//number of points
...
//csvread functions
void csvreadx(){
    std::ifstream inputFile("/home/xu/catkin_ws/src/areas736_745/Boat/Boat4506161/Boat00_4506161_long.csv"); //path
    std::string line;
...
void csvready(){
    std::ifstream inputFile("/home/xu/catkin_ws/src/areas736_745/Boat/Boat4506161/Boat00_4506161_lati.csv"); //path
    std::string line;
    while (getline(inputFile,line)){
        std::string number;
        std::istringstream readstr(line); //string2stream  //devided with'，'
...
void csvreadcog(){
    std::ifstream inputFile("/home/xu/catkin_ws/src/areas736_745/Boat/Boat4506161/Boat00_4506161_COG.csv"); //path
    std::string line;
    while (getline(inputFile,line)){
        std::string number;
        std::istringstream readstr(line); //string2stream  //devided with'，'
...
void csvreadupdate(){
    std::ifstream inputFile("/home/xu/catkin_ws/src/areas736_745/Boat/Boat4506161/Boat00_4506161_timeinterval.csv"); //path
    std::string line;
    while (getline(inputFile,line)){
        std::string number;
        std::istringstream readstr(line); //string2stream  //devided with'，'
...
void csvreadtime(){
    std::ifstream inputFile("/home/xu/catkin_ws/src/areas736_745/Boat/Boat4506161/Boat00_4506161_time.csv"); //path
    std::string line;
    while (getline(inputFile,line)){
        std::string number;
        std::istringstream readstr(line); //string2stream  //devided with'，'
...
{
  ros::init(argc, argv, "Boat00_4506161");
  ros::NodeHandle n;
  ...
  while (ros::ok())
  {
    ...
    points.ns = line_strip.ns = line_list.ns = "Boat00_4506161";
  ...
  line_strip.scale.x = 0.3;
   ...
   ros::Duration(data_line_update[j]/12).sleep();
    ...
    //ROS info out put
    ROS_INFO_STREAM("Ship_id:  " <<"Boat00_4506161");
